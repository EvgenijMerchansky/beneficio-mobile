export const CONTENT = `<Text>Privacy Policy</Text>
<Text>Effective date: July 17, 2019</Text>
<Text>Beneficio ("us", "we", or "our") operates the Beneficio mobile application (the "Service").</Text>
...
<View>
    <Text><strong>Session Cookies.</strong> We use Session Cookies to operate our Service.</Text>
    <Text><strong>Preference Cookies.</strong> We use Preference Cookies to remember your preferences and various settings.</Text>
    <Text><strong>Security Cookies.</strong> We use Security Cookies for security purposes.</Text>
</View>
<Text>Use of Data</Text>
<Text>Beneficio uses the collected data for various purposes:</Text>
<View>
...
<Text>If you are located outside Ukraine and choose to provide information to us, please note that we transfer the data, including Personal Data, to Ukraine and process it there.</Text>
...
<Text>Beneficio will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</Text>
<Text>Disclosure Of Data</Text>
<Text>Legal Requirements</Text>
<Text>Beneficio may disclose your Personal Data in the good faith belief that such action is necessary to:</Text>
<View>
    <Text>To comply with a legal obligation</Text>
    <Text>To protect and defend the rights or property of Beneficio</Text>
...
<View>
    <Text>By email: beneficioinc@gmail.com</Text>
</View>`;